...
Access to Zane Benefits systems and application is limited for all users, including but not limited to workforce members, volunteers, business associates, contracted providers, consultants, and any other entity, is allowable only on a minimum necessary basis. All users are responsible for reporting an incident of unauthorized user or access of the organization’s information systems. These safeguards have been established to address the HIPAA Security regulations including the following:
...
* Requests for access to Zane Benefits Platform systems and applications is made formally to the CTO, Privacy Officer, or Security Officer.
* Access is not granted until receipt, review, and approval by the Zane Benefits Security Officer;
* The request for access is retained for future reference.
* All access to Zane Benefits systems and services are reviewed and updated on an bi-annual basis to assure proper authorizations are in place commiserate with job functions. The form used to conduct account review is [here](TBD).
* Any Zane Benefits workforce member can request change of access using this [form](TBD).
...
* Generic accounts are not allowed on Zane Benefits systems.
* Access is granted through encrypted, secure connections.
	* SSL utilizes AES 128 bit encryption.
...
* Zane Benefits maintains a minimum necessary approach to access to Customer data. As such, Zane Benefits, including all workforce members, does not readily have access to any ePHI.

## Access Authorization

* Role based access categories for each Zane Benefits system and application are pre-approved by the Security Officer or CTO.
* Zane Benefits utilizes firewalls to segment data, prevent unauthorized access, and monitor traffic for denial of service attacks.
...
* Access to the Zane Benefits Platform systems and applications is controlled by requiring unique User Login ID’s and passwords for each individual user.
...
* Shared accounts are not allowed within Zane Benefits systems or networks.
...
All workstations at Zane Benefits are company owned.
...
* All workstations are to have the following messages added to the lock screen and login screen: *This computer is owned by Zane Benefits. By logging in, unlocking, and/or using this computer you acknowledge you have seen, and follow, these policies (https://www.zanebenefits.com/policy/) and have completed this training (TBD link). Please contact us if you have problems with this - privacy-officer@zanebenefits.com.*
...
* The Security Officer will terminate user's access rights immediately upon notification.
...
Zane Benefits does not use paper records for any sensitive information. Use of paper for recording and storing sensitive data is against Zane Benefits policies.

## Password Management

* User IDs and passwords are used to control access to Zane Benefits systems and may not be disclosed to anyone for any reason.
...
Zane Benefits grants SaaS Customers secure system access via secured, encrypted connections. This access is only to Customer-specific data, no other data in the environment.

In the case of an investigation, Zane Benefits will assist customers, at Zane Benefits' discretion, and law enforcement in forensics.